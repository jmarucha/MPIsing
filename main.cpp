...
const char *argp_program_version = "MPIsing 1.0";
...
static struct argp_option options[] = {
    {"verbose", 'v', 0, 0, "Produce verbose (per round) output",
     OPT_GROUP_GENERAL},
    ...
    {"save-png", OPT_SAVE_PNG, 0, 0, "Save png every few rounds",
     OPT_GROUP_PNG},
    {"every-nth-round", OPT_PNG_EVERY_NTH_ROUND, "INT", 0,
     "Set PNG writing interval (in rounds)", OPT_GROUP_PNG},
    {"output-dir", OPT_PNG_OUTPUT_DIR, "DIR", 0, "PNGs output directory",
     OPT_GROUP_PNG},
...
enum parse_errors { __ARGP_ERR_UNKNOWN = ARGP_ERR_UNKNOWN, HELP_MSG };
...
void print_header() { puts("time, magnetization"); }
